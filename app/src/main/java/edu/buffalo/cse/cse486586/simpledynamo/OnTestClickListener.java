        ...
        private boolean testDelete() {
            try {
                ...
                for (int i = 0; i < TEST_CNT; i++) {
                    ...
                    int resultCursor = mContentResolver.delete(mUri,"*",
                            new String[]{key});
                    if (resultCursor == 0) {
        ...
        private boolean testDeleteAll() {
            try {
                ...
                for (int i = 0; i < TEST_CNT; i++) {
                    ...
                    int resultCursor = mContentResolver.delete(mUri,"*",null);
                    if (resultCursor == 0) {
                        Log.e(TAG, "Result null");
                        throw new Exception();
                    }
        ...
        private boolean testQuery() {
            try {
                ...
                for (int i = 0; i < TEST_CNT; i++) {
                    ...
                    Log.v("ONtestCLick Query", DatabaseUtils.dumpCursorToString(resultCursor));
